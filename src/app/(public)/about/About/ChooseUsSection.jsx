      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Title
            ...
            color="text-white"
            weight="bold"
            className="uppercase text-lg md:text-xl mb-4"
          >
            {t("heading")}
          </Title>
          ...
          {features.map(({ icon: Icon, key, color }, idx) => (
            ...
            >
              <div className="relative bg-white/90 backdrop-blur-sm p-8 rounded-3xl shadow-xl border border-white/20 hover:bg-white hover:shadow-2xl transition-all duration-500 h-full flex flex-col">
                <div
                  className={`w-16 h-16 bg-gradient-to-r ${color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-all duration-300 shadow-lg`}
                >
