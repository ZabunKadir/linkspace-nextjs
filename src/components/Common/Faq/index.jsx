  ...
  return (
    <div className="flex flex-col justify-center items-center mt-10 lg:mt-20 px-4">
      <div className="w-full max-w-2xl sm:max-w-3xl md:max-w-4xl text-center mb-6">
        <h2 className="relative font-bold text-darkPurple text-3xl sm:text-4xl md:text-5xl inline-block">
          <span className="relative z-10 text-4xl md:text-7xl font-calsans">
